...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\AnalyticsBundle\\Producer\\DataSenderProducer' => 'getDataSenderProducerService.php',
            ...
            'old_sound_rabbit_mq.send_email_consumer' => 'getOldSoundRabbitMq_SendEmailConsumerService.php',
            'old_sound_rabbit_mq.send_email_producer' => 'getOldSoundRabbitMq_SendEmailProducerService.php',
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'AnalyticsBundle' => [
                    'path' => ($this->targetDirs[3].'/src/AnalyticsBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'AnalyticsBundle' => 'App\\AnalyticsBundle\\AnalyticsBundle',
            ...
            'old_sound_rabbit_mq.base_amqp' => [
                0 => 'old_sound_rabbit_mq.send_email_producer',
                1 => 'old_sound_rabbit_mq.send_email_consumer',
            ],
            'console.command.ids' => [
