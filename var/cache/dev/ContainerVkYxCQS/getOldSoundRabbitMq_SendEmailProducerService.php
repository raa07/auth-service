...
// Returns the public 'old_sound_rabbit_mq.send_email_producer' shared service.
...
$this->services['old_sound_rabbit_mq.send_email_producer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Producer(($this->services['old_sound_rabbit_mq.connection.default'] ?? $this->load('getOldSoundRabbitMq_Connection_DefaultService.php')));
